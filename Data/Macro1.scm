...
(view:zoom-all)
(edit:clear-selection)
(edit:add-selection (tools:face-in-body 1 (entity 1)))
(edit:clear-selection)
(edit:add-selection (tools:face-in-body 0 (entity 1)))
(edit:add-selection (tools:face-in-body 522 (entity 1)))
(edit:add-selection (tools:face-in-body 521 (entity 1)))
(edit:add-selection (tools:face-in-body 519 (entity 1)))
(edit:add-selection (tools:face-in-body 518 (entity 1)))
...
(property:apply-surface (tools:face-in-body 522 (entity 1)) (list "Perfect Absorber" "Default")
  (gvector 0 0 0) (gvector 0 0 0)
  (position 0 0 0) (gvector 0 0 0) #t)
(property:apply-surface (tools:face-in-body 521 (entity 1)) (list "Perfect Absorber" "Default")
  (gvector 0 0 0) (gvector 0 0 0)
  (position 0 0 0) (gvector 0 0 0) #t)
(property:apply-surface (tools:face-in-body 519 (entity 1)) (list "Perfect Absorber" "Default")
  (gvector 0 0 0) (gvector 0 0 0)
  (position 0 0 0) (gvector 0 0 0) #t)
(property:apply-surface (tools:face-in-body 518 (entity 1)) (list "Perfect Absorber" "Default")
  (gvector 0 0 0) (gvector 0 0 0)
  (position 0 0 0) (gvector 0 0 0) #t)
...
(edit:clear-selection)
(edit:add-selection (tools:face-in-body 0 (entity 2)))
(property:apply-flux-surface-source (tools:face-in-body 0 (entity 2)) 100 1000 2 #f)
...
(raytrace:source)     
     ...
     (do                                     ;; loop over "i" form      
       ...
       (entity:rotate (entity 31) 750 10200 0 0 0 1 angle);;對z軸旋轉 num 度  
       (do                     
