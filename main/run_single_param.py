...
def main():
    sid_ang = [0.57, 0.64, 77.44] # S1, S2, A1
    base_dir = os.path.dirname(os.path.abspath(__file__))
    output_dir = r"C:\Users\cchih\Desktop\NTHU\3rd_last_semester\CIRP\regression_model\SIM"
    folder = os.path.join(output_dir, "[0.57, 0.64, 77.44]_N1.2536_F2_53_34_sub0.6")
