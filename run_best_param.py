...
def main():
    ...
    output_dir = r"C:\Users\cchih\Desktop\NTHU\MasterThesis\research_log\best_params\[0.76,0.9,59]_Compensate\SIM_561"
    folder = os.path.join(output_dir, "[0.68, 0.83, 58.6]_N1.2536_F2_61_53_sub0.6")
