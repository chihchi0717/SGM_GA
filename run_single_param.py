...
def main():
    ...
    output_dir = r"C:\Users\cchih\Desktop\NTHU\MasterThesis\research_log\best_params\Optimize_Regression\[0.82, 0.78, 65.65]\SIM_design"
    folder = os.path.join(output_dir, "[0.82, 0.78, 65.65]_N1.2536_F2_53_34_sub0.6")
